...
const file_health_v1_health_proto_rawDesc = "" +
	...
	"\x1eSERVING_STATUS_SERVICE_UNKNOWN\x10\x032\x9a\x01\n" +
	"\x06Health\x12F\n" +
	"\x05Check\x12\x1d.health.v1.HealthCheckRequest\x1a\x1e.health.v1.HealthCheckResponse\x12H\n" +
	"\x05Watch\x12\x1d.health.v1.HealthCheckRequest\x1a\x1e.health.v1.HealthCheckResponse0\x01B\xa9\x01\n" +
	"\rcom.health.v1B\vHealthProtoP\x01ZFrahulxf.com/general-connectrpc-demo/internal/gen/go/health/v1;healthv1\xa2\x02\x03HXX\xaa\x02\tHealth.V1\xca\x02\tHealth\\V1\xe2\x02\x15Health\\V1\\GPBMetadata\xea\x02\n" +
...
var file_health_v1_health_proto_depIdxs = []int32{
	0, // 0: health.v1.HealthCheckResponse.status:type_name -> health.v1.ServingStatus
