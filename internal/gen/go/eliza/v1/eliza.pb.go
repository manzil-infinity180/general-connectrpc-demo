...
const file_eliza_v1_eliza_proto_rawDesc = "" +
	"\n" +
	"\x14eliza/v1/eliza.proto\x12\beliza.v1\"(\n" +
	"\n" +
	"SayRequest\x12\x1a\n" +
	...
	"\bsentence\x18\x01 \x01(\tR\bsentence2\xda\x01\n" +
	"\fElizaService\x127\n" +
	"\x03Say\x12\x14.eliza.v1.SayRequest\x1a\x15.eliza.v1.SayResponse\"\x03\x90\x02\x01\x12G\n" +
	"\bConverse\x12\x19.eliza.v1.ConverseRequest\x1a\x1a.eliza.v1.ConverseResponse\"\x00(\x010\x01\x12H\n" +
	"\tIntroduce\x12\x1a.eliza.v1.IntroduceRequest\x1a\x1b.eliza.v1.IntroduceResponse\"\x000\x01B\xa1\x01\n" +
	"\fcom.eliza.v1B\n" +
	"ElizaProtoP\x01ZDrahulxf.com/general-connectrpc-demo/internal/gen/go/eliza/v1;elizav1\xa2\x02\x03EXX\xaa\x02\bEliza.V1\xca\x02\bEliza\\V1\xe2\x02\x14Eliza\\V1\\GPBMetadata\xea\x02\tEliza::V1b\x06proto3"
